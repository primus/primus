 ...
 *
 * Checks if any message has been received from the client before sending another
 * heartbeat. If not, we can assume it's dead (no response to our last ping),
 * so we should close.
 *
 * This is intentionally writable so it can be overwritten for custom heartbeat policies.
 *
 * @returns {undefined}
 * @api public
 */
